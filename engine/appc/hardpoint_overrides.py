...
def _drydock(find):
    ...
    if p is not None:
        ...
        p.SetLightEmitterUp(0, -2.7305778508484993e-05, 0.9999978050748778, -0.0020950178570149913)
        ...
        p.SetLightEmitterIntensity(1, 1.0)
        p.SetLightEmitterAxis(1, 0.013032537873834791, -0.002095195796757821, -0.9999128777604279)
        p.SetLightEmitterLength(1, 3.1730451523104186)
        p.SetLightEmitterRadiusY(1, 1.352016388925882)
        p.SetLightEmitterUp(1, 2.7305778508484986e-05, 0.9999978050748778, -0.002095017857014991)
        ...
        p.SetLightEmitterIntensity(2, 1.0)
        p.SetLightEmitterAxis(2, 0.013032537873834791, -0.002095195796757821, -0.9999128777604279)
        p.SetLightEmitterLength(2, 3.1730451523104186)
        p.SetLightEmitterRadiusY(2, 1.352016388925882)
        p.SetLightEmitterUp(2, 2.7305778508484986e-05, 0.9999978050748778, -0.002095017857014991)
        ...
        p.SetLightEmitterIntensity(3, 1.0)
        p.SetLightEmitterAxis(3, -0.013032537873834791, -0.002095195796757821, -0.9999128777604279)
        p.SetLightEmitterLength(3, 3.1730451523104186)
        p.SetLightEmitterRadiusY(3, 1.352016388925882)
        p.SetLightEmitterUp(3, -2.7305778508484986e-05, 0.9999978050748778, -0.002095017857014991)
